  ...
  <div>
    <section class="co-hero-wrap">
      <svg width="0" height="0" class="absolute">
        <defs>
          <clipPath id="pvHeroClip" clipPathUnits="objectBoundingBox">
          ...
          <clipPath id="pvHeroClipMobile" clipPathUnits="objectBoundingBox">
      ...
      <div class="co-hero-section pv-hero-clip">
...
<style>
.pv-hero-clip {
  clip-path: url(#pvHeroClipMobile);
}
@media (min-width: 640px) {
  .pv-hero-clip {
    clip-path: url(#pvHeroClip);
  }
}
</style>
